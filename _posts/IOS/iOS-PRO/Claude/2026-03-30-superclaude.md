...
/sc:brainstorm 나는 iOS 개발자야 새로운 프로젝트를 하나 하려고 해

iOS 앱에 건강 앱이 있잖아 

근데 그건 너무 정보가 방대해서 사용하기 힘들어 그리고 ui도 너무 안이쁘고
사용자 친화적이지 못한것 같아. 그리고 위젯도 너무 안이뻐.

그래서 이쁘고 간단한 건강+피트니스 앱을 만들고싶은데 워치앱도 만들거야 

그리고 안드로이드 앱도 만들거야

현재 아이디어가 추상적이라서 구체화좀 하고싶어

일단 많이걸으면 캐릭터가 위젯에서 활기차게 적게 걸으면 힘없게? 있는 캐릭터 기반의 좀 귀여운 UI로 갈거야